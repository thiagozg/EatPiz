...
<html>
	<head>
		<title><spring:message code="views.cadastrar.titulo" /></title>
		...
		<div class="panel panel-default">
			<div class="panel-body">
			   <div class="container">
					<c:if test="${not empty mensagemErro}">
						<div>
							<div class="alert alert-danger">
								<spring:message code="views.mensagens.pizzaria.cadastro.erro" />
							</div>
						</div>
					</c:if>
					...
					<section id="cadastro-pizzarias">
						<div class="well">
							<form id="form-pizzaria" method="post" th:action="@{/pizzarias}" th:object="${pizzaria}" action="">
								<div class="modal-header">
									<h4 class="modal-title"><spring:message code="views.cadastrar.titulo" /></h4>
								</div>
								<div class="modal-body">
									...
									<input id="usuario.login" name="usuario.login" class="form-control" required />
									...
									<input id="endereco" name="endereco" class="form-control" required />
									
									<label for="dataCadastro" class="inp-data"><spring:message code="views.menu.editar.data" /></label>
							  		<div id="datetimepicker" class="input-append date">
								    	<input data-format="dd/MM/yyyy hh:mm:ss" type="text" id="dataCadastro" name="dataCadastro" style="height: auto;" required></input>
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" onClick="location='${path}/clientes'"><spring:message code="views.login.cancelar" /></button>
									<button id="btn-salvar" type="submit" class="btn btn-primary"><spring:message code="views.cadastrar.botao" /></button>
								</div>
							</form>
						</div>
					</section>
