...
public class Pizza {
	...
	// não se pode usar List com Hibernate pq pode causar problemas
	// Set = mesma coisa q a lista mas não trás ordenado
	@ManyToMany
	private Set<Ingrediente> ingredientes;
	
	/**
	 *  direcionamento unidimensional por enquanto, 
	 *  pizzaria nao conhece seus ingredientes,
	 *  mas os ingrediente sabe a quem ele pertence
	 */
	@ManyToOne
